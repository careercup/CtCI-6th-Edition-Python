...
def find_max_depth(node, level=0):
    ...
    return max(find_max_depth(node.left, level + 1), find_max_depth(node.right, level + 1))
...
def find_min_depth(node, level=0):
    ...
    return min(find_min_depth(node.left, level + 1), find_min_depth(node.right, level + 1))
